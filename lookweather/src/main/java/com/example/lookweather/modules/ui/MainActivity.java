package com.example.lookweather.modules.ui;
...
import com.xiecc.lookWeather.common.CircularAnimUtil;
import com.xiecc.lookWeather.common.PLog;
import com.xiecc.lookWeather.common.Util;
import com.xiecc.lookWeather.modules.domain.Weather;
import com.xiecc.lookWeather.modules.receiver.WidgetProviderWeek;
import com.xiecc.lookWeather.modules.service.AutoUpdateService;
import com.xiecc.lookWeather.modules.ui.ChoiceCityActivity;
import com.xiecc.lookWeather.modules.ui.about.AboutActivity;
import com.xiecc.lookWeather.modules.ui.setting.CityFrgment;
import com.xiecc.lookWeather.modules.ui.setting.Setting;
import com.xiecc.lookWeather.modules.ui.setting.SettingActivity;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener
    ...
    private final String TAG = com.xiecc.lookWeather.modules.ui.MainActivity.class.getSimpleName();
            ...
            public void onPageSelected(int position) {
                if (position == 1) {
                    ...
                    fab.setBackgroundTintList(
                            ColorStateList.valueOf(ContextCompat.getColor(com.xiecc.lookWeather.modules.ui.MainActivity.this, R.color.colorPrimary)));
                    fab.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(com.xiecc.lookWeather.modules.ui.MainActivity.this, ChoiceCityActivity.class);
                            intent.putExtra(mSetting.MULTI_CHECK, true);
                            CircularAnimUtil.startActivity(com.xiecc.lookWeather.modules.ui.MainActivity.this, intent, fab,
                    ...
                    fab.setBackgroundTintList(
                            ColorStateList.valueOf(ContextCompat.getColor(com.xiecc.lookWeather.modules.ui.MainActivity.this, R.color.colorAccent)));
                    fab.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            showFabDialog();
    ...
    private void showFabDialog() {
        new AlertDialog.Builder(com.xiecc.lookWeather.modules.ui.MainActivity.this).setTitle("点赞")
                ...
                .setPositiveButton("好叻", (dialog, which) -> {
                    ...
                    com.xiecc.lookWeather.modules.ui.MainActivity.this.startActivity(intent);        //启动Activity
                })
                .show();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_set:
                Intent intentSetting = new Intent(com.xiecc.lookWeather.modules.ui.MainActivity.this, SettingActivity.class);
    ...
    public void normalStyleNotification(Weather weather) {
        Intent intent = new Intent(com.xiecc.lookWeather.modules.ui.MainActivity.this, com.xiecc.lookWeather.modules.ui.MainActivity.class);
        //intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        PendingIntent pendingIntent =
            PendingIntent.getActivity(com.xiecc.lookWeather.modules.ui.MainActivity.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        Notification.Builder builder = new Notification.Builder(com.xiecc.lookWeather.modules.ui.MainActivity.this);
    ...
    public void startUpdataService(Weather weather ) {
        awm= AppWidgetManager.getInstance(this);
                // 激活主键--通讯
                ComponentName provider=new ComponentName(com.xiecc.lookWeather.modules.ui.MainActivity.this, WidgetProviderWeek.class);
                RemoteViews views=new RemoteViews(getPackageName(), R.layout.widget_week);
                //动作
                Intent intent=new Intent(com.xiecc.lookWeather.modules.ui.MainActivity.this, com.xiecc.lookWeather.modules.ui.MainActivity.class);
                //延迟意图
                PendingIntent pendingIntent=PendingIntent.getActivity(com.xiecc.lookWeather.modules.ui.MainActivity.this, 0, intent, 0);
