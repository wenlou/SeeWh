package com.example.lookweather.modules.service;
...
import com.xiecc.lookWeather.common.ACache;
...
import com.xiecc.lookWeather.modules.ui.MainActivity;
...
public class AutoUpdateService extends Service {
    ...
    private final String TAG = com.xiecc.lookWeather.modules.service.AutoUpdateService.class.getSimpleName();
    ...
    private void normalStyleNotification(Weather weather) {
        Intent intent = new Intent(com.xiecc.lookWeather.modules.service.AutoUpdateService.this, MainActivity.class);
        //intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        PendingIntent pendingIntent =
            PendingIntent.getActivity(com.xiecc.lookWeather.modules.service.AutoUpdateService.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        Notification.Builder builder = new Notification.Builder(com.xiecc.lookWeather.modules.service.AutoUpdateService.this);
