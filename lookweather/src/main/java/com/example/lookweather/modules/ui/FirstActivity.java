...
import com.xiecc.lookWeather.component.GanHuo;
import com.xiecc.lookWeather.component.GankRetrofit;
import com.xiecc.lookWeather.component.GankService;
...
//        });
        ...
        GankRetrofit.getRetrofit()
                ...
                .subscribe(new Observer<GanHuo>() {
                    ...
                    @Override
                    public void onError(Throwable e) {
                        Glide.with(com.xiecc.lookWeather.modules.ui.FirstActivity.this)
    ...
    private void animateImage() {
        ...
        scaleAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                startActivity(new Intent(com.xiecc.lookWeather.modules.ui.FirstActivity.this,MainActivity.class));

                overridePendingTransition(0,0);

                com.xiecc.lookWeather.modules.ui.FirstActivity.this.finish();
            }
