    ...
    public void startUpdataService(Weather weather ) {
        awm= AppWidgetManager.getInstance(this);
                ...
                try {
                    ...
                    Log.i("hhhhhh",weather.dailyForecast.get(0).date);
                    Log.i("hhhhhh",weather.dailyForecast.get(1).date);
                    Log.i("hhhhhh",weather.dailyForecast.get(2).date);
                    views.setTextViewText(R.id.widget_week_week_3,Util.dayForWeek(weather.dailyForecast.get(2).date));
                    //views.setTextViewText(R.id.widget_week_week_4,Util.dayForWeek(weather.dailyForecast.get(1).date));
                    //views.setTextViewText(R.id.widget_week_week_5,Util.dayForWeek(weather.dailyForecast.get(2).date));
                } catch (Exception e) {
                    e.printStackTrace();
                }
